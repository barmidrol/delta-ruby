...
class TableTest < Minitest::Test
  ...
  def test_compact
    ...
    with_table(df) do |dt|
      ...
      assert_equal 0, metrics["filesAdded"]["avg"]
      assert_equal 0, metrics["filesAdded"]["max"]
      assert_equal 0, metrics["filesAdded"]["min"]
      assert_equal 0, metrics["filesAdded"]["totalFiles"]
      assert_equal 0, metrics["filesAdded"]["totalSize"]
      assert_equal 0, metrics["filesRemoved"]["avg"]
      assert_equal 0, metrics["filesRemoved"]["max"]
      assert_equal 0, metrics["filesRemoved"]["min"]
      assert_equal 0, metrics["filesRemoved"]["totalFiles"]
      assert_equal 0, metrics["filesRemoved"]["totalSize"]
